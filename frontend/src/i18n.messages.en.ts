export const messagesEn: Record<string, string> = {
  ...
  'invoice.howToRequest': 'How would you like to request?',
  'invoice.createInvoice': 'Create invoice',
  'invoice.createInvoiceDesc': 'Generate a professional invoice with QR code',
  'invoice.sharePaymentLink': 'Share payment link',
  'invoice.sharePaymentLinkDesc': 'Create a simple link to share anywhere',
  ...
  'invoice.createLink': 'Create link',
  ...
  'errors.transferMinimum': 'Minimum transfer is 0.01 TRV.',
