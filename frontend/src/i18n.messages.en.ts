export const messagesEn: Record<string, string> = {
  ...
  'account.nickname.title': 'Nickname',
  'account.nickname.subtitle': 'Set a nickname to receive transfers.',
  'account.nickname.hint': 'Use 3–20 characters: letters, numbers, dot, hyphen, or underscore.',
  'account.nickname.saved': 'Nickname updated.',
