export const messagesPtBR: Record<string, string> = {
  ...
  'statement.type.convertUsdToTrv': 'Conversão USD → TRV',
  'statement.type.convertTrvToUsd': 'Conversão TRV → USD',
  ...
  'account.nickname.title': 'Apelido',
  'account.nickname.subtitle': 'Defina um apelido para receber transferências.',
  'account.nickname.hint': 'Use 3–20 caracteres: letras, números, ponto, hífen ou underline.',
  'account.nickname.saved': 'Apelido atualizado.',
