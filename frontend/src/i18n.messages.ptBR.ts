export const messagesPtBR: Record<string, string> = {
  ...
  'invoice.howToRequest': 'Como você gostaria de solicitar?',
  'invoice.createInvoice': 'Criar fatura',
  'invoice.createInvoiceDesc': 'Gere uma fatura profissional com QR code',
  'invoice.sharePaymentLink': 'Compartilhar link de pagamento',
  'invoice.sharePaymentLinkDesc': 'Crie um link simples para compartilhar em qualquer lugar',
  ...
  'invoice.paymentLink': 'Link de pagamento',
  'invoice.copyLink': 'Copiar link',
  'invoice.share': 'Compartilhar',
  'invoice.createNew': 'Criar nova',
  'invoice.createLink': 'Criar link',
